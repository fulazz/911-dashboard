...
fig_category = px.bar(df['product_category_name'].value_counts(), x='product_category_name', y='product_category_name',
                      labels={'product_category_name': 'Count'}, title='Product Category Distribution')
